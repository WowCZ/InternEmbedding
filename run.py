...
training_parser.add_argument('--backbone_type', type=str, default='Mistral', help='Supported backbone types: [Mistral, BERT, Phi]')
...
training_parser.add_argument('--peft_lora', type=bool, default=False, help='Training as lora strategy or not')
...
training_parser.add_argument('--ckpt_saving_dir', type=str, default='/fs-computility/llm/shared/chenzhi/ckpts', help='The saving path of the embedder checkpoint')
...
evaluating_parser.add_argument('--peft_lora', type=bool, default=False, help='Training as lora strategy or not')
...
evaluating_parser.add_argument('--embedding_norm', type=bool, default=True, help='Normalize the embedding or not')
...
predicting_parser.add_argument('--backbone_type', type=str, default='Mistral', help='Supported backbone types: [Mistral, BERT, Phi, BGE]')
...
predicting_parser.add_argument('--peft_lora', type=bool, default=False, help='Training as lora strategy or not')
...
predicting_parser.add_argument('--task_prompt', type=bool, default=True, help='Using task prompt or not')
...
predicting_parser.add_argument('--embedding_norm', type=bool, default=False, help='Normalize the embedding or not')
