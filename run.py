...
training_parser.add_argument('--reserved_layers', nargs='+', type=int, default=None, help='The reserved layers to caculate the hidden representation')
training_parser.add_argument('--flashatt', action='store_true', default=False, help='Using Flash Attention or not')
...
evaluating_parser.add_argument('--flashatt', action='store_true', default=False, help='Using Flash Attention or not')
...
evaluating_parser.add_argument('--reserved_layers', nargs='+', type=int, default=None, help='The reserved layers to caculate the hidden representation')
...
evaluating_parser.add_argument('--result_dir', type=str, default='/fs-computility/llm/chenzhi/InternEmbedding/results', help='The saved path of the evalyated results')
...
predicting_parser.add_argument('--flashatt', action='store_true', default=False, help='Using Flash Attention or not')
...
predicting_parser.add_argument('--reserved_layers', nargs='+', type=int, default=None, help='The reserved layers to caculate the hidden representation')
...
predicting_parser.add_argument('--mteb_evaluation_tasks', nargs='+', type=str, default=["Banking77Classification", "EmotionClassification", "ImdbClassification", "MedrxivClusteringS2S", "TwitterSemEval2015", "AskUbuntuDupQuestions", "ArguAna", "NFCorpus", "SciFact", "BIOSSES", "STS17", "STSBenchmark"], help='The evaluation tasks in MTEB')
predicting_parser.add_argument('--result_dir', type=str, default='/fs-computility/llm/chenzhi/InternEmbedding/results', help='The saved path of the evalyated results')
