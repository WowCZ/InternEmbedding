...
def predict_embedder(args):
    ...
    instructions = ["Help Translate the Chinese version corresponding to the following question:", 
                    "Help find the correct English response for the following question:", 
                    "Help Translate the Russian version corresponding to the following question:"]
