...
from embedding.models.modeling_phi import PhiEmbedder
...
def evaluate_embedder(args):
    ...
    elif args.backbone_type == 'Phi':
        tokenizer.pad_token = tokenizer.eos_token
        embedder = PhiEmbedder(args.init_backbone, pool_type=args.pool_type, checkpoint_batch_size=10, embed_dim=-1, lora_config=args.peft_lora, which_layer=args.which_layer, mytryoshka_indexes=mytryoshka_indexes).to(args.device)
